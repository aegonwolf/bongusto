            ...
            <div class="relative">
              ...
              {#if pagesDropdownOpen}
                ...
                <div class="absolute right-0 z-20 mt-3 w-52 space-y-1 bg-gray-secondary-50 p-2.5 outline-none drop-shadow filter">
                  <a href="/" class="block px-5 py-3.5 font-medium text-slate-700 transition duration-300 ease-in-out hover:bg-gray-secondary-100/60 hover:text-slate-900">Home</a>
                  <a href="/about" class="block px-5 py-3.5 font-medium text-slate-700 transition duration-300 ease-in-out hover:bg-gray-secondary-100/60 hover:text-slate-900">About</a>
                  <a href="/pricing" class="block px-5 py-3.5 font-medium text-slate-700 transition duration-300 ease-in-out hover:bg-gray-secondary-100/60 hover:text-slate-900">Pricing</a>
                  <a href="/contact" class="block px-5 py-3.5 font-medium text-slate-700 transition duration-300 ease-in-out hover:bg-gray-secondary-100/60 hover:text-slate-900">Contact</a>
                  <a href="/signin" class="block px-5 py-3.5 font-medium text-slate-700 transition duration-300 ease-in-out hover:bg-gray-secondary-100/60 hover:text-slate-900">Sign in</a>
                  <a href="/signup" class="block px-5 py-3.5 font-medium text-slate-700 transition duration-300 ease-in-out hover:bg-gray-secondary-100/60 hover:text-slate-900">Sign up</a>
                  <a href="/password-reset" class="block px-5 py-3.5 font-medium text-slate-700 transition duration-300 ease-in-out hover:bg-gray-secondary-100/60 hover:text-slate-900">Password reset</a>
                  <a href="/404" class="block px-5 py-3.5 font-medium text-slate-700 transition duration-300 ease-in-out hover:bg-gray-secondary-100/60 hover:text-slate-900">404</a>
                </div>
              {/if}
            </div>
          </div>
              ...
              <div class="relative">
                ...
                {#if pagesDropdownOpen}
                  <div class="z-20 space-y-0 px-4">
                    <div class="mt-2">
                      <a href="/" class="block px-3 py-3 font-medium text-slate-700 transition duration-300 ease-in-out hover:bg-amber-50 hover:text-slate-900">Home</a>
                    </div>
                    <div class="mt-2">
                      <a href="/about" class="block px-3 py-3 font-medium text-slate-700 transition duration-300 ease-in-out hover:bg-amber-50 hover:text-slate-900">About</a>
                    </div>
                    <div class="mt-2">
                      <a href="/pricing" class="block px-3 py-3 font-medium text-slate-700 transition duration-300 ease-in-out hover:bg-amber-50 hover:text-slate-900">Pricing</a>
                    </div>
                    <div class="mt-2">
                      <a href="/contact" class="block px-3 py-3 font-medium text-slate-700 transition duration-300 ease-in-out hover:bg-amber-50 hover:text-slate-900">Contact</a>
                    </div>
                    <div class="mt-2">
                      <a href="/signin" class="block px-3 py-3 font-medium text-slate-700 transition duration-300 ease-in-out hover:bg-amber-50 hover:text-slate-900">Sign in</a>
                    </div>
                    <div class="mt-2">
                      <a href="/signup" class="block px-3 py-3 font-medium text-slate-700 transition duration-300 ease-in-out hover:bg-amber-50 hover:text-slate-900">Sign up</a>
                    </div>
                    <div class="mt-2">
                      <a href="/password-reset" class="block px-3 py-3 font-medium text-slate-700 transition duration-300 ease-in-out hover:bg-amber-50 hover:text-slate-900">Reset password</a>
                    </div>
                    <div class="mt-2">
                      <a href="/404" class="block px-3 py-3 font-medium text-slate-700 transition duration-300 ease-in-out hover:bg-amber-50 hover:text-slate-900">404</a>
                    </div>
                  </div>
                {/if}
              </div>
