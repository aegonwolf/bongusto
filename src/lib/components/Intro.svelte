    ...
    <div class="mx-auto max-w-lg pb-14 md:mx-0 md:max-w-none md:pb-48 lg:pb-52 xl:max-w-xl xl:pb-14">
      ...
      <ul class="mt-6 flex flex-col space-y-4 md:mx-auto md:mt-8 md:max-w-3xl md:flex-row md:space-x-2 md:space-y-0 lg:space-x-4 xl:mx-0 xl:flex-col xl:space-x-0 xl:space-y-4">
        <li class="flex items-center md:items-start xl:items-center">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="h-5 w-5 shrink-0 text-slate-800 md:h-6 md:w-6 xl:h-5 xl:w-5">
  ...
  <div class="bg-gradient-to-r from-vanilla via-amber-50 to-amber-100">
    <div class="relative mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8">
      <div class="mx-auto max-w-lg pb-8 pl-4 pt-20 md:mx-0 md:max-w-md lg:max-w-lg lg:pb-16 lg:pt-28 xl:max-w-xl xl:py-12 xl:pl-14 2xl:pl-0">
        <blockquote>
          ...
          <div class="mt-7 flex items-center">
            <div class="h-14 w-14 rounded-full bg-gray-secondary-100">
      ...
      <div class="absolute bottom-0 right-6 hidden w-1/3 bg-gray-secondary-100 md:block lg:right-12 xl:-right-0 xl:w-full xl:max-w-xl 2xl:-right-32 2xl:max-w-[640px]">
        <img src="images/hansibrigitte.jpg" class="h-auto w-full object-cover" alt="Home Hero Image" />
      </div>
    </div>
  </div>
</section>
