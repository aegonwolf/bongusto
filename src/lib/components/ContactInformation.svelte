    ...
    <section class="relative bg-vanilla py-16 sm:py-20">
        ...
        <div class="mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8">
          <div
            class="mx-auto grid max-w-lg items-center gap-12 sm:max-w-xl md:max-w-2xl lg:mx-0 lg:max-w-none lg:grid-cols-12"
          >
            <div class="lg:col-span-5">
              ...
              <p class="mt-4 max-w-sm leading-relaxed text-slate-700 lg:mt-5">
            ...
            >
              <!-- Card 1 -->
              <div
                class="border border-gray-secondary-400/60 bg-gray-secondary-50 px-6 py-8 xl:p-10"
              >
                <div class="flex space-x-6 xl:space-x-8">
                  ...
                  <div>
                    ...
                    <p class="mt-6 text-md font-medium text-slate-900">
                      Email address:
                    </p>
                    <p class="mt-1 text-sm text-slate-700">info@wavy.com</p>
                  </div>
                </div>
              </div>
              ...
              >
                <div class="flex space-x-6 xl:space-x-8">
                  ...
                  <div>
                    ...
                    <p class="mt-1 text-sm text-slate-700">(323) 123-4567</p>
                  </div>
                </div>
              </div>
              ...
              >
                <div class="flex space-x-6 xl:space-x-8">
                  ...
                  <div>
                    <h3 class="text-xl font-semibold text-slate-900">Sales</h3>
                    <p class="mt-6 text-md font-medium text-slate-900">
                      Email address:
                    </p>
                    <p class="mt-1 text-sm text-slate-700">sales@wavy.com</p>
                  </div>
                </div>
              </div>
              ...
              >
                <div class="flex space-x-6 xl:space-x-8">
                  ...
                  <div>
                    ...
                    <p class="mt-1 text-sm text-slate-700">press@wavy.com</p>
                  </div>
                </div>
              </div>
            </div>
